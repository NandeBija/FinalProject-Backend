...
//UPDATE USERS
router.put("/:id", [verifyTokenAndAdmin, getUser], async (req, res, next) => {
...
// DELETE A USER
router.delete("/:id", [verifyTokenAndAuthorization,verifyTokenAndAdmin, getUser], async (req, res, next) => {
